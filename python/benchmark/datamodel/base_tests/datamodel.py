...
from rtypes.pcc.attributes import primarykey, dimension, predicate
...
#     @predicate(BaseSet.Number)
#     def __predicate__(num):
#         return num % 2 == 0

# @subset(BaseSet)
# class SubsetAll(BaseSet):
#     @predicate(BaseSet.ID)
