...
class ScalableTestSuite(BaseTestSuite):
    def generate_client(self, groupname, sim_num, testcase, stats_queue):
        ...
        return Simulation(
            ...
            combination_c, foldername_c, app_id_c, queue=stats_queue)
    ...
    def make_scalable_test_group(self, testcase):
        ...
        master = Simulation(
            ...
            combination_m, foldername_m, app_id_m, queue=stats_queue)
        client_gen = (
            self.generate_client(groupname, i, testcase, stats_queue)
...
#@register
class MysqlScaleTestSuite(ScalableTestSuite):
    def __init__(self, args, foldername, logger):
        super(MysqlScaleTestSuite, self).__init__(args, foldername, logger)
