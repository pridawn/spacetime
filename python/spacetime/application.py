...
from spacetime.debugger_server import server_func, register_func
...
class DebugNode(Process):
    ...
    def start_async(self, *args, **kwargs):
        ...
        self.node = Node(debug_function, Types={CheckoutObj, CommitObj, PushObj, PullObj, AcceptPullObj,
                                                AcceptPushObj, ConfirmPullObj}, dataframe=(self.debug[0], self.port))
